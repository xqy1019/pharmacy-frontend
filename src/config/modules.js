export const moduleGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/stocktake', key: 'stocktake', label: '盘点与损益管理', shortLabel: '盘点损益' },
      { path: '/quality', key: 'quality', label: '质量控制与召回管理', shortLabel: '质量召回' }
    ]
  },
  {
    title: '决策与治理',
    items: [
      { path: '/analytics', key: 'analytics', label: '统计报表与分析中心', shortLabel: '分析中心' },
      { path: '/system', key: 'system', label: '系统管理与权限审计', shortLabel: '系统管理' }
    ]
  }
];

export const allModules = moduleGroups.flatMap((group) => group.items);
